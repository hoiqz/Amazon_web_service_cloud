<?php 
#$bucket_root = 'pauline.c.ng.lab';
#$userfolder= '/UserUpload';
#$bucket= $bucket_root.$userfolder;
 ...
 *    */
define('awsAccessKey', 'AKIAJIW6ILF2DR2GTRXA');
 ...
 *    */
define('AWS_CANONICAL_NAME', 'Pauline Ng');
